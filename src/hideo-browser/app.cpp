...
export Ui::Child app(Rc<Dom::Window> window) {
    ...
    state.bookmarks.pushBack({.name = "The Project (snapshot)"s, .url = "bundle://hideo-browser.main/www-the-project.html"_url});
    state.bookmarks.pushBack({.name = "Google (snapshot)"s, .url = "bundle://hideo-browser.main/google.html"_url});
    state.bookmarks.pushBack({.name = "Hackernews (snapshot)"s, .url = "bundle://hideo-browser.main/hackernews.html"_url});
