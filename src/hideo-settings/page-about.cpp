                ...
                return Ok(
                    Ui::vflow(
                        Kr::rowContent(
                            ...
                            "System"s,
                            NONE,
                            Some(Ui::text(sysinfo.sysName))
                        ),
                        Kr::rowContent(
                            NONE,
                            "System Version"s,
                            NONE,
                            Some(Ui::text(sysinfo.sysVersion))
                        ),
                        Kr::rowContent(
                            NONE,
                            "Kernel"s,
                            NONE,
                            Some(Ui::text(sysinfo.kernelName))
                        ),
                        Kr::rowContent(
                            NONE,
                            "Kernel Version"s,
                            NONE,
                            Some(Ui::text(sysinfo.kernelVersion))
                        )
                    )
                );
            });
                ...
                for (auto& cpu : cpusinfo) {
                    children.pushBack(
                        Kr::rowContent(
                            ...
                            "CPU"s,
                            NONE,
                            Some(Ui::text("{} {} {} MHz", cpu.name, cpu.brand, cpu.freq))
                        )
                    );
                }
